...
/*
 ...
 2. New Protocol - NetworkManagerDownloadDelegate. 
...
/*
 Error Report:
 1. File name parsing error: if the file name on the web is red, NetworkManager could not parse it.
 */
...
@protocol NetworkManagerDownloadDelegate;
...
@interface NetworkManager : NSObject <NSURLConnectionDataDelegate, NSURLConnectionDelegate> {
    ...
    id <NetworkManagerDownloadDelegate> delegate;
}
...
// @since 1.0.4
@property (strong, nonatomic) id <NetworkManagerDownloadDelegate> delegate;
